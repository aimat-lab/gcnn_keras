...
class GatherNodes(ks.layers.Layer):
    ...
    def call(self, inputs):
        ...
        out = tf.RaggedTensor.from_row_splits(get,edgeind.row_splits,validate=False)         
        return out     
...
class GatherNodesOutgoing(ks.layers.Layer):
    ...
    def call(self, inputs):
        ...
        out = tf.RaggedTensor.from_row_splits(g2,edgeind.row_splits,validate=False)         
        return out     
...
class GatherNodesIngoing(ks.layers.Layer):
    ...
    def call(self, inputs):
        ...
        out = tf.RaggedTensor.from_row_splits(g1,edgeind.row_splits,validate=False)         
        return out  
...
class GatherState(ks.layers.Layer):
    ...
    def call(self, inputs):
        ...
        out = tf.RaggedTensor.from_row_splits(out,nod.row_splits,validate=False)
        return out           
...
class LazyConcatenateNodes(ks.layers.Layer):
    ...
    def call(self, inputs):
        ...
        out = tf.RaggedTensor.from_row_splits(out,node.row_splits,validate=False) 
        return out     
