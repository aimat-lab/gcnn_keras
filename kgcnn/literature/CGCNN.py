...
model_default = {
    'name': 'CGCNN',
    'inputs': {
        'atom_attributes': {'shape': (None,), 'name': 'atom_attributes', 'dtype': 'int64', 'ragged': True},
        'frac_coords': {'shape': (None, 3), 'name': 'frac_coords', 'dtype': 'float64', 'ragged': True},
        'multiplicities': {'shape': (None,), 'name': 'multiplicities', 'dtype': 'int64', 'ragged': True},
        'cell_translations': {'shape': (None, 3), 'name': 'cell_translations', 'dtype': 'float32', 'ragged': True},
        'symmops': {'shape': (None, 4, 4), 'name': 'symmops', 'dtype': 'float64', 'ragged': True},
        'lattice_matrix': {'shape': (3, 3), 'name': 'lattice_matrix', 'dtype': 'float64'},
        'edge_indices': {'shape': (None, 2), 'name': 'edge_indices', 'dtype': 'int64', 'ragged': True},
        'edge_distances': {'shape': (None,), 'name': 'edge_distances', 'dtype': 'float64', 'ragged': True}
    },
