...
def getmodelGCN(
    ...
    Args:
        ...
        output_use_bias (bool,list): Use bias for output. Optionally list for multiple layer. D
    ...
    for i in range(0, depth):
        n = GCN(hidden_dim, use_bias=use_bias, activation=activation, pooling_method='segment_sum', is_sorted=is_sorted,
                has_unconnected=has_unconnected, node_indexing='batch')([n, ed, edi])
