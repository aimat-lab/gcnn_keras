...
@tf.keras.utils.register_keras_serializable(package='kgcnn', name='AttentiveHeadFP_')
class AttentiveHeadFP_(GraphBaseLayer):
...
@tf.keras.utils.register_keras_serializable(package='kgcnn', name='PoolingNodesAttentive_')
class PoolingNodesAttentive_(GraphBaseLayer):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        """Initialize layer."""
        super(PoolingNodesAttentive_, self).__init__(**kwargs)
    ...
    def build(self, input_shape):
        """Build layer."""
        super(PoolingNodesAttentive_, self).build(input_shape)
    ...
    def get_config(self):
        """Update layer config."""
        config = super(PoolingNodesAttentive_, self).get_config()
