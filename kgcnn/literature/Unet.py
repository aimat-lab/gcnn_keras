...
def make_unet_disjoint(
    ...
    for i in range(0, depth):
        ...
        nu = kgcnn.layers.disjoint.pooling.PoolingLocalEdges(pooling_method='segment_mean', is_sorted=is_sorted, has_unconnected=has_unconnected)(
        ...
        # Pooling
        i_graph, i_map = kgcnn.layers.disjoint.topk.PoolingTopK(k=k, kernel_initializer=score_initializer)([n, node_len, ed, edge_len, edi])
