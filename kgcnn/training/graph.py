...
def train_graph_regression_supervised(X, y,
    ...
    for train_index, test_index in split_indices:
        ...
        xtrain, ytrain = X[train_index].tensor(ragged=is_ragged), y[train_index]
        xtest, ytest = X[test_index].tensor(ragged=is_ragged), y[test_index]
...
def train_graph_classification_supervised():
    pass
