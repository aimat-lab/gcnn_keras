    ...
    "MXMNet.EnergyForceModel": {
        ...
        "training": {
            ...
            "fit": {
                ...
                "callbacks": [
                    {"class_name": "kgcnn>LinearWarmupExponentialLRScheduler", "config": {
                        "lr_start": 1e-03, "gamma": 0.995, "epo_warmup": 1, "verbose": 1, "steps_per_epoch": 4031}}
                ]
            },
            "compile": {
            ...
            "dataset": {
                ...
                "methods": [
                    ...
                    {"map_list": {"method": "set_angle", "range_indices": "edge_indices", "edge_pairing": "jk",
                                  "angle_indices": "angle_indices_1", "node_coordinates": "positions",
                    ...
                    {"map_list": {"method": "set_angle", "range_indices": "edge_indices", "edge_pairing": "ik",
                                  ...
                                  "angle_indices": "angle_indices_2", "node_coordinates": "positions",
