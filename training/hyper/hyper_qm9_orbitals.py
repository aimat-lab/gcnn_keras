...
hyper = {
    ...
    "Megnet": {
        ...
        "training": {
            ...
            "multi_target_indices": target_index  # 5, 6, 7 = Homo, Lumo, Gap or combination
        },
        "data": {
            "dataset": {
                "class_name": "QM9Dataset",
    ...
    "NMPN": {
        ...
        "training": {
            ...
            "compile": {
                "optimizer": {"class_name": "Adam", "config": {"learning_rate": 1e-04}},
                "loss": "mean_absolute_error"
            },
            "scaler": {"class_name": "QMGraphLabelScaler", "config": {
                "atomic_number": "node_number",
    ...
    "MXMNet": {
        "model": {
            ...
            "config": {
                ...
                "input_edge_embedding": {"input_dim": 32, "output_dim": 128},
        ...
        "training": {
            ...
            "compile": {
                "optimizer": {"class_name": "Adam", "config": {"learning_rate": 1e-04, "global_clipnorm": 1000}},
                "loss": "mean_absolute_error",
                "metrics": [
    ...
    "EGNN": {
        ...
        "training": {
            ...
            "compile": {
                "optimizer": {"class_name": "Adam", "config": {"learning_rate": 0.5e-03}},
                "loss": "mean_absolute_error"
            },
            "scaler": {"class_name": "QMGraphLabelScaler", "config": {
                "atomic_number": "node_number",
